...
const DropButton = ({nombre,dataMenu}) => {
  return (
    <Dropdown action={<Button className='px-6 py-2 bg-slate-600 hover:bg-slate-700 text-white  font-normal rounded-lg'>{nombre} <span className='ml-3'><ChevronDownIcon className="size-4" /></span> </Button>} actionClassName="border-none">
